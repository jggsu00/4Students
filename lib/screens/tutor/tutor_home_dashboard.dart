...
class _TutorHomeContentState extends State<TutorHomeContent> {
  // Helper to switch tabs via the parent dashboard
                              ...
                              children: [
                                Expanded(
                                  child: ElevatedButton.icon(
                                    onPressed: () => _navigateToTab(2), // QR tab
                                ...
                                Expanded(
                                  child: ElevatedButton.icon(
                                    onPressed: () => _navigateToTab(1), // Schedule tab
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(child: _buildStatCard('5', 'Sessions')),
                                const SizedBox(width: 10),
                                Expanded(child: _buildStatCard('87', 'Check-Ins')),
                                const SizedBox(width: 10),
                                Expanded(child: _buildStatCard('73%', 'Attendance')),
                              ],
                            ),
                          ],
                        ),
